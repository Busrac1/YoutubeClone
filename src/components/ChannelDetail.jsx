...
const ChannelDetail = ({detail}) => {
  return (
    <>
        <h1 className="mt-3 text-xl font-bold p-3">
        {detail.title}
      </h1>
      ...
      <div className="flex justify-between items-center p-3">
        <div className="flex items-center gap-4">
          ...
          <button 
          className="bg-white h-9 rounded-full text-black px-3 transition hover:bg-[#bebebe]">
            Abone ol
          </button>
        </div>
        <div className="flex items-center rounded-full py-1 px-6 text-lg bg-[#4b4a4a]">
